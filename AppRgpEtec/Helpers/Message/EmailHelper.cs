...
namespace AppRgpEtec.Helpers.Message
{
    class EmailHelper
    {
        public async Task EnviarEmail(Models.Email email)
        {
            try
            {
                ...
                //Outras opções --> Anexo;
                //byte[] arquivoAnexo = null; string contentType = "application/pdf"; //imagem/png ou //imagem /jpeg
                //mailMessage.Attachments.Add(new Attachment(new MemorySteam(arquivoAnexo), "nomeArquivo", "contenType));
